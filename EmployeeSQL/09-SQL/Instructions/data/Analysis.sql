-- 1. the following details of each employee: employee number, first name, last name, gender and salary.
...
-- 3. List. the. manage at. each department with the. following. information: dept.no, dept name, the manager's employee no., last name, first name, last name
...
GROUP BY
	last_name
ORDER BY
	last_name_frequency_count DESC
